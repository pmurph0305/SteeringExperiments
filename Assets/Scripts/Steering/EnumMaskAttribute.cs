...
/// <summary>
/// Adds default inspector for enum bitmasks decorated as [Flag]
/// </summary>
/// <remarks>
/// Code by Bunny83 http://answers.unity3d.com/questions/393992/custom-inspector-multi-select-enum-dropdown.html
/// Probably similar to https://www.assetstore.unity3d.com/en/?#!/content/12206
/// </remarks>
...
public class EnumBitMaskPropertyDrawer : PropertyDrawer
{
  public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
  {
    ...
    prop.intValue = BitMaskDrawer.DrawBitMaskField(position, prop.intValue, typeAttr.propType, label);
  }
}